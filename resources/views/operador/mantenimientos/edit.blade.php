...
<div class="row">
  <div class="col-md-8 offset-md-2">
    <div class="card">
      ...
      <form action="{{ route('operador.mantenimientos.update', $mantenimiento['id']) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <small class="text-muted">Para cerrar use el botón "Cerrar" en el listado.</small>
          </div>
        ...
        <div class="card-footer">
          ...
          <a href="{{ route('operador.mantenimientos.index') }}" class="btn btn-secondary ms-2">
